...
DAYS_TO_GO_BACK = 3  # Global variable to set the number of days to go back
...
def fetch_and_export_orders():
    ...
    for order in all_orders:
        ...
        for item in node['lineItems']['edges']:
            ...
            # Calculate merchandise discount for this line item
            total_merchandise_discount = sum(float(
            ...
            row_data = {
                ...
                'Total Merchandise Discounts': total_merchandise_discount,  # Per line item
    ...
    column_order = [
        ...
        'SKU', 'Quantity', 'Line Item Price', 'Line Item Tax', 'Duties'
    ]
